...
class UnitTestReport extends StatefulWidget {
  final List<QuestionModel> questions;

  const UnitTestReport({Key key, this.questions}) : super(key: key);

  @override
  _UnitTestReportState createState() => _UnitTestReportState();
}

class _UnitTestReportState extends State<UnitTestReport> {
  int _currentIndex;
