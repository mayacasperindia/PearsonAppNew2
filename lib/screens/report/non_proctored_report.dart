...
class NonProctoredReport extends StatefulWidget {
  final List<QuestionModel> questions;

  const NonProctoredReport({Key key, this.questions}) : super(key: key);

  @override
  _NonProctoredReportState createState() => _NonProctoredReportState();
}

class _NonProctoredReportState extends State<NonProctoredReport> {
  int _currentIndex;
