...
class PreviousYearReport extends StatefulWidget {
  final List<QuestionModel> questions;

  const PreviousYearReport({Key key, this.questions}) : super(key: key);

  @override
  _PreviousYearReportState createState() => _PreviousYearReportState();
}

class _PreviousYearReportState extends State<PreviousYearReport> {
  int _currentIndex;
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Expanded(child: DropdownButton<String>(
                                underline: Container(),
                                isExpanded: true,
                                value: attemptValue,
                                onChanged: (String newValue) {
            ...
            headerSliverBuilder:
              ...
              return [
                SliverAppBar(
                  ...
                  title: Text('Previous Year Paper Report'),
