...
class TestSeriesHome extends StatefulWidget {
  final List<String> syllabus;
  final VoidCallback onAccountTap;

  const TestSeriesHome({Key key, this.syllabus, this.onAccountTap})
      : super(key: key);

  @override
  _TestSeriesHomeState createState() => _TestSeriesHomeState();
}

class _TestSeriesHomeState extends State<TestSeriesHome>
  ...
  TabBar makeTabBar() {
    return TabBar(
      ...
      tabs: <Tab>[
        Tab(text: 'Proctored test'.toUpperCase()),
        Tab(text: 'Non-proctored test'.toUpperCase()),
      ],
